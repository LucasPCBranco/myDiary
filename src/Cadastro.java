...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jConfirm = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setText("Seu login:");

        butCadastro.setLabel("Cadastrar");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jSenha, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
                            .addComponent(jLogin)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jConfirm, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void butCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butCadastroActionPerformed
        ...
        if(a.equals(b)){
            BancoDados.insert("usuario", "idusuario, login, senha", "" + null + ", '"
                     + jLogin.getText() + "', '" + jSenha.getText() + "'");
            JOptionPane.showMessageDialog(null, "SUCESSO!");
        }else{
            System.out.println("ERRO. Senhas não batem");
        }
    ...
    private javax.swing.JTextField jConfirm;
